...
import { Upload, FileText, CheckCircle2, XCircle, Users } from 'lucide-react'
...
export function RosterImport({ teamId, onImportComplete, onSkip }: RosterImportProps) {
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-lg overflow-hidden">
            <Table>
              ...
              <TableBody>
                {parsedPlayers.slice(0, 15).map((player, idx) => (
                  <TableRow key={idx}>
                ...
                {parsedPlayers.length > 15 && (
                  <TableRow>
                    <TableCell colSpan={5} className="text-center text-muted-foreground text-sm">
                      ... and {parsedPlayers.length - 15} more players
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
          ...
          <div className="flex items-center space-x-3 p-3 rounded-lg bg-muted/50">
            ...
            <div className="flex-1">
              <Label htmlFor="include-stats" className="font-medium cursor-pointer">
                Import stats too
              </Label>
              <p className="text-xs text-muted-foreground">
      ...
      {/* Skip button when no file selected */}
      {parsedPlayers.length === 0 && onSkip && !parsing && (
        <div className="flex justify-end">
          <Button variant="ghost" onClick={onSkip}>
            Skip - I&apos;ll add players manually
          </Button>
        </div>
      )}
    </div>
